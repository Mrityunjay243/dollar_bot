...
The code that implements this feature can be found [here](https://github.com/Mrityunjay243/dollar_bot/blob/main/code/estimate.py)
...
![alt text](https://github.com/Mrityunjay243/dollar_bot/blob/main/docs/estimate.png)
